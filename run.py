...
import os
import time
from encodermenu.encoder_menu import *

print("hello world")

import freesans20 as freesans20  # Font to use
from picolcd.picolcd import LCD_1inch14
...
burn_profile = []
for file in os.listdir("/storage/profiles"):
    if file.endswith(".json"):
        burn_profile.append(file.rsplit(".", 1)[0])
